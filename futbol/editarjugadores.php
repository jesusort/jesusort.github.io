...
<nav class="navbar navbar-default">
	...
	<?php 
		...
		$id_jugadores = $_GET['id'];

		$sql = "SELECT * FROM jugadores";
		$jugadores = $conexion->query($sql)->fetch_object();
	 ?>
	 <div class="container">
		<div class="row well">
			<div class="col-md-6 col-md-offset-3">
				<form action="updatejugadores.php" method="POST">
					<input type="hidden" name="id" value="<?php echo $jugadores->id;  ?>">
					<div class="form-group">
						<label for="Nombre">Nombre:</label>
						<input type="text" name="nombre" class="form-control" value="<?php echo $jugadores->nombre; ?>">
					</div>
					<div class="form-group">
						<label for="">Equipo</label>
						<input type="text" name="equipo" class="form-control" value="<?php echo $jugadores->equipo; ?>">
					</div>
					<div class="form-group">
						<label for="Nacionalidad">Nacionalidad</label>
						<input type="text" name="nacionalidad" class="form-control" value="<?php echo $jugadores->nacionalidad; ?>">
					</div>
					<div class="form-group">
						<label for="">Edad</label>
						<input type="number" name="edad" class="form-control" value="<?php echo $jugadores->edad; ?>">
					</div>
					<div class="form-group">
						<label for="">Fecha de Nacimiento</label>
						<input type="text" name="fechadenacimiento" class="form-control" value="<?php echo $jugadores->fechadenacimiento; ?>">
					</div>					
